...
<body>
    ...
    <div class="container">
        <div class="tab-buttons">
            <img src="Logo/upec.png" alt="logo_upec" style="width: 200px;
            text-align: left;">
            <a href="#" onclick="showSection('inscription')" style="margin-left: 130px;">Inscription</a>
            <a href="#" onclick="showSection('connexion')">Connexion</a>
        </div>
        ...
        <div class="section" id="connexion">
            ...
            <form action="traitement_connexion.php" method="POST">
                ...
                <input type="text" id="email_connexion" name="email_connexion" required>
